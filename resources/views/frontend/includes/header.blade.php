				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="{{ asset('frontend/images/logo2.png') }}" alt=" " class="img-fluid">Banglar Hat
						</a>
					</h1>
				</div>
				<!-- //logo -->
				...
				<div class="agileits-navi_search">
					<form action="#" method="post">
						<select id="agileinfo-nav_search" name="agileinfo_search" class="border" required="">
							...
							<option value="Televisions">হস্তশিল্প </option>
							<option value="Headphones">কুটিরশিল্প</option>
							<option value="Computers">বেতশিল্প</option>
							<option value="Appliances">মৃৎশিল্প</option>
							<option value="Mobiles">ঐতিহ্যবাহী খাবার</option>
						</select>
					</form>
				</div>
